...
public static String ImagesFolderServer="LTACESFAImagesServer";
	...
	public static int DATABASE_VERSIONID = 93;      // put this field value based on value in table on the server
...
*/
    ...
    public static String WebServicePath = "http://www.ltace.com/PDADataService/FSService.asmx";
    ...
    public static int DATABASE_VERSIONID = 104;      // put this field value based on value in table on the server
    public static String AppVersionID = "1.9";   // put this field value based on value in table on the server
    public static int Application_TypeID = 5; //1=Parag Store Mapping,2=Parag SFA Indirect,3=Parag SFA Direct

    public static String WebPageUrlQuatation = "http://www.ltace.com/frmCostBreakUp.aspx";

    public static final String COMMON_SYNC_PATH_URL = "http://www.ltace.com/PDAFileReceivingApp/Default.aspx?FileType=";

    public static String ClientFileNameOrderSync = "XML_SFA_FSD";
    public static String ClientFileNameOrderSyncPathDistributorMap = "XML_DistributorMapping_FSD";
    public static String ClientFileNameImageSyncPath = "IMAGE_ImageFiles";
    public static String ClientFileNameInvoiceSyncPath = "XML_InvoiceFile_FSD";
    public static String ClientFileNameDistributorSyncPath = "XML_DistributionFile_FSD";
    public static String ClientFileNameOrderSyncPathSO = "XML_OutletFile_FSD";
    public static String ClientFileNameVideoSyncPath = "Video_VideoFiles";
    ...
    public static final String Database_Assistant_DB_NAME = "DBLTFSD";
